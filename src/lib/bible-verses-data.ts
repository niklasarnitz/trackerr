// Verse counts for each chapter of the Bible (Protestant Canon)
// Key: Book ID (matching src/lib/bible-data.ts)
// Value: Array of numbers, where index 0 corresponds to Chapter 1, index 1 to Chapter 2, etc.
...
export const BIBLE_VERSE_COUNTS: Record<string, number[]> = {
  ...
  // Apocrypha (Approximate common counts)
  tob: [22, 14, 17, 21, 22, 18, 18, 21, 6, 13, 19, 22, 18, 15],
  jdt: [16, 28, 10, 15, 24, 21, 32, 36, 14, 23, 23, 20, 20, 19, 13, 25],
  add_est: [17, 7, 7, 16, 24, 10], // Approximate for Additions A-F
  wis: [16, 24, 19, 20, 23, 25, 30, 21, 19, 21, 26, 27, 19, 31, 19, 29, 20, 25, 22],
  sir: [30, 18, 31, 31, 15, 37, 36, 19, 18, 31, 34, 18, 26, 27, 20, 30, 32, 33, 30, 31, 28, 27, 28, 34, 26, 29, 30, 26, 28, 25, 31, 24, 31, 31, 20, 31, 31, 34, 35, 30, 22, 25, 33, 23, 26, 20, 25, 25, 16, 29, 30],
  bar: [22, 35, 37, 37, 9, 73],
  add_dan: [68, 64, 42], // Song of Three (68), Susanna (64), Bel (42) approx
